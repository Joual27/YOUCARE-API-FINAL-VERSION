...
class ListingController extends Controller
{
    ...
    public function listingRequest()
    {
        ...
        $applications = DB::table('applications')
            ...
            ->select('applications.*', 'listings.title as listing_title', 'users.name as volunteer_name')
            ->where('listings.organizer_id', $user->organizer()->first()->id)
            ->where('applications.status', 'pending')
            ->groupBy('applications.id','listings.title','users.name')
            ->get();
    ...
    public function decline(Request $request)
    {
        ...
        return response()->json(['posit_id' => $posit, 'message' => 'The application has been successfully declined.'],201);
    }
    /**
    ...
    public function authenticatedOrganizerListings()
    {
        try{
            $user = JWTAuth::user();
